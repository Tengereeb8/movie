...
export const Footer = () => {
  return (
    <div className=" w-full lg:max-w-360 mx-auto h-77 relative top-16 flex flex-col justify-between bg-[#4338CA] py-10 px-5 gap-7 text-[#FAFAFA] md:flex-row lg:px-20 lg:pt-10 lg:pb-16 ">
